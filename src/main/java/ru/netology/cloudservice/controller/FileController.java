...
public class FileController {
    ...
    public ResponseEntity<?> getItemList(
        ...
        return Logback.log(fileService.getItemList(limit, headerAuthToken));
    }
    ...
    public ResponseEntity<?> downloadItem(
            ...
            @RequestHeader("auth-token") Optional<String> headerAuthToken) {
        return Logback.log(fileService.downloadItem(filename, headerAuthToken));
    }
    ...
    public ResponseEntity<Error> saveItem(@RequestParam("filename") String filename,
                                          ...
                                          @RequestHeader("auth-token") Optional<String> headerAuthToken) {
        return Logback.log(fileService.saveItem(filename, file, headerAuthToken));
    }
    ...
    public ResponseEntity<Error> updateItem(
            ...
            @RequestHeader("auth-token") Optional<String> headerAuthToken) {
        return Logback.log(fileService.updateItem(oldFilename, newFilename.getFilename(), headerAuthToken));
    }
    ...
    public ResponseEntity<Error> deleteItem(
            @RequestParam("filename") String filename,
            @RequestHeader("auth-token") Optional<String> headerAuthToken) {
        return Logback.log(fileService.deleteItem(filename, headerAuthToken));
    }
}
